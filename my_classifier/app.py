...
app.config['UPLOAD_FOLDER'] = '/home/garima/Documents/my_classifier/static/uploads/'
# These are the extension that we are accepting to be uploaded
app.config['ALLOWED_EXTENSIONS'] = set(['txt', 'pdf', 'png', 'jpg', 'jpeg', 'gif'])

label_lines = [line.rstrip() for line 
               in tf.gfile.GFile("/home/garima/Documents/my_classifier/retrained_labels.txt")]
# Unpersists graph from file
with tf.gfile.FastGFile("/home/garima/Documents/my_classifier/retrained_graph.pb", 'rb') as f:
...
@app.route('/home/garima/Documents/my_classifier/static/uploads/<filename>')
def uploaded_file(filename):
    start_time = 0
    start_time = time.time()
    # change this as you see fit
    #image_path = sys.argv[1]
    image_path="/home/garima/Documents/my_classifier/static/uploads/"+filename
    strng = " "
